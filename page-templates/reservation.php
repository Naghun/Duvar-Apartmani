...
<div class="page-wrapper">
	...
	<div class="<?php echo esc_attr( $container ); ?> m-auto">
        ...
        <img src="<?php echo get_theme_file_uri('/src/images/makeljica-house.jpg'); ?>" alt="Naslovna slika" class="col-12"></div>


		<div class="row d-flex justify-content-center align-items-center m-0 p-0">
            <div class="reservation-container col-12 justify-content-center align-items-center">
                <h3 class="d-flex justify-content-center align-items-center">APARTMAN U BLAGAJU VAM PRUŽA UDOBAN I KOMFORAN SMJEŠTAJ</h3>
            </div>
        </div><!-- .row -->
